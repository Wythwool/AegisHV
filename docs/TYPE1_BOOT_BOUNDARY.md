...
- Guard pages and a hypervisor-owned host page-table root; the bring-up kernel still uses Limine's mappings. Its reservation covers only the inherited active root page, not the lower page-table tree.
