...
pub use toy_guest::{
    ...
    TYPE1_TOY_DEADLINE_PROBE_RIPS, TYPE1_TOY_GDT_BASE, TYPE1_TOY_GDT_LIMIT, TYPE1_TOY_GUEST_CS,
    TYPE1_TOY_GUEST_PML4_GPA, TYPE1_TOY_GUEST_RFLAGS, TYPE1_TOY_GUEST_RIP, TYPE1_TOY_GUEST_RSP,
    TYPE1_TOY_GUEST_SS, TYPE1_TOY_HLT_EXIT_RFLAGS, TYPE1_TOY_HLT_RIP, TYPE1_TOY_IDT_BASE,
    TYPE1_TOY_IDT_LIMIT, TYPE1_TOY_IO_BITMAP_B_RIP, TYPE1_TOY_IO_RIP, TYPE1_TOY_PAT_INDEX,
    TYPE1_TOY_PAT_MISMATCH_HLT_RIP, TYPE1_TOY_PAT_RDMSR_RIP, TYPE1_TOY_RDMSR_INDEX,
    TYPE1_TOY_RDMSR_RIP, TYPE1_TOY_SIMD_GUARD_RIP, TYPE1_TOY_STACK_GPA, TYPE1_TOY_UD2_RIP,
    TYPE1_TOY_UD_HANDLER_COOKIE, TYPE1_TOY_UD_HANDLER_RIP, TYPE1_TOY_X87_GUARD_RIP,
};
...
pub const SERIAL_VMX_GUEST_UD_INJECT_OK_MARKER: &str = "aegishv:type1:guest-ud-inject-ok";
...
pub const SERIAL_VMX_GUEST_UD_INJECT_ERROR_MARKER: &str = "aegishv:type1:guest-ud-inject-error";
...
mod tests {
    ...
    fn runtime_backend_markers_fit_serial_line_buffer() {
        ...
        for marker in [
            ...
            SERIAL_VMX_GUEST_UD_INJECT_OK_MARKER,
            ...
            SERIAL_VMX_GUEST_UD_INJECT_ERROR_MARKER,
        ] {
