...
fn qemu_evidence_script_records_digest_marker_and_exit_status() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "serial_markers_present=",
            "serial_markers_in_order=",
            "serial_markers_exactly_once=",
            "forbidden_backend_none_observed=",
            "forbidden_marker_observed=",
            "aegishv:type1:guest-preempt-exit-ok",
            "aegishv:type1:guest-io-exit-ok",
            "aegishv:type1:guest-pat-state-ok",
            "aegishv:type1:guest-nm-x87-exit-ok",
            ...
            "aegishv:type1:guest-ud-inject-error",
            "aegishv:type1:guest-timeout",
            "vmx_cpu_signature_valid=",
            "vmx_timer_rate_valid=",
            "vmx_timer_reload_valid=",
            "vmx_timer_effective_valid=",
            "vmx_timer_semantics_valid=",
            "vmx_timer_budget_limit=",
            "vmx_diagnostics_valid=",
            "qemu_evidence_exit_status=",
            "qemu_machine=",
            "qemu_cpu=",
            "qemu_boot_mode=",
            "qemu_command=",
...
fn opt_in_type1_lab_runner_chains_tools_iso_and_qemu_evidence() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "qemu_evidence=",
            "lab_complete=",
            "one fixed vector-6 VM-entry injection",
            "not evidence of general exceptions",
            "exit \"$qemu_status\"",
        ],
    );
